 ...
 * @author gunee_000
 */
public class AdmModBook extends javax.swing.JFrame {
...
String qry="select booktit,bookaut,bookpub,bookprc,bookcopies,bookstackno from book where bookid="+bid;
...
jTextField9.setText(rs.getString("bookstackno"));
...
JOptionPane.showMessageDialog(null, "Updation Successful");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdmModBook().setVisible(true);
            }
        });
    }
