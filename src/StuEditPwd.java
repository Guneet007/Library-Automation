 ...
 * @author gunee_000
 */
public class StuEditPwd extends javax.swing.JFrame {

    /**
     * Creates new form StuEditPwd
     */
    public StuEditPwd() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Student Edit Password");
...
String qry="select stuid from student where stupwd='"+oldpwd+"'";
ResultSet rs=new DB().execute(qry);
if(rs.next())
{
if(newpwd.equals(conpwd))
{
qry="update student set stupwd='"+newpwd+"' where stupwd='"+oldpwd+"'";
new DB().update(qry);
...
{JOptionPane.showMessageDialog(null,"Wrong Old Password");}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StuEditPwd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StuEditPwd().setVisible(true);
            }
        });
    }
